...
public class GNScopeAccessImpl extends ASTWrapperPsiElement implements GNScopeAccess {

  public GNScopeAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GNVisitor visitor) {
    visitor.visitScopeAccess(this);
  }

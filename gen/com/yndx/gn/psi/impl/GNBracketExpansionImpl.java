...
public class GNBracketExpansionImpl extends ASTWrapperPsiElement implements GNBracketExpansion {

  public GNBracketExpansionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GNVisitor visitor) {
    visitor.visitBracketExpansion(this);
  }
